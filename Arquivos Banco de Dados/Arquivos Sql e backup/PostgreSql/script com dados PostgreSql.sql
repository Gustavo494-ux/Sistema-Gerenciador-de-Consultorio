...
idStatusAgendamento  int PRIMARY KEY,
...
idSintomasReferidos int PRIMARY KEY,
idConsulta int,
...
idAntecedentesOculares int PRIMARY KEY,
idConsulta int,
...
idMotilidadeOcular int PRIMARY KEY,
idConsulta int,
kappaOe varchar(100),
KappaOd varchar(100),
hirschberg varchar,
...
idOftalmoscopia int PRIMARY KEY,
idConsulta int,
...
idAcuidadeVisual int PRIMARY KEY,
idConsulta int,
vlOdSg varchar(10),
vlOeSg varchar(10),
vlAoSg varchar(10),
...
idAntecedentesGerais int PRIMARY KEY,
idConsulta int,
...
idBiomicroscopia int PRIMARY KEY,
idConsulta int,
...
idCeratometria int PRIMARY KEY,
idConsulta int,
od varchar(100),
oe varchar(100),
...
idRetinoscopia int PRIMARY KEY,
idConsulta int,

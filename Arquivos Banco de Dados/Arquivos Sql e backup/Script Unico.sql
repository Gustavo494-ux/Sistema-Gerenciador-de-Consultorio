...
ALTER TABLE rxInicial ADD FOREIGN KEY(idConsulta) REFERENCES consulta (idConsulta);
...
ALTER TABLE rxFinal ADD FOREIGN KEY(idConsulta) REFERENCES consulta (idConsulta);
...
INSERT INTO endereco(cidade,idUsuario) VALUES 
('Campinas',1),

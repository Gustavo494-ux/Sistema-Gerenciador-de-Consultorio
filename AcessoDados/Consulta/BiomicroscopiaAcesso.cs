...
namespace AcessoDados
{
    public class BiomicroscopiaAcesso
    {
        ...
        public bool CadastrarBiomicroscopia(string IDCONSULTA,string SOBRANCELHAOD,string SOBRANCELHAOE, string CILIOOD,string CILIOE, string PALPEBRAOD, string PALPEBRAOE, string CONJUNTIVAOD, 
            string CONJUNTIVAOE,string ESCLEROTICAOD,string ESCLEREOTICAOE,string CORNEAOD, string CORNEAOE,string IRISOD, string IRISOE,string CRISTALINOOD, string CRISTALINOOE,
            string CAMARAANTERIOROD, string CAMARAANTERIOROE,string OBSERVACAOBIOMICROSCOPIA)
        {
            try
            {
                ...
                sql.Append("corneaOd,corneaoOe,irisOd,irisOe,cristalinoOd,cristalinoOe,camaraAnteriorOd,camaraAnteriorOe,observacaoBiomicroscopia) VALUES(IDCONSULTA,SOBRANCELHAOD,SOBRANCELHAOE, ");
                sql.Append("CILIOOD,CILIOOE,PALPEBRAOD,PALPEBRAOE,CONJUNTIVAOD,CONJUNTIVAOE,ESCLEROTICAOD,ESCLEROTICAOE,CORNEAOD,CORNEAOOE,IRISOD,IRISOE,CRISTALINOOD,CRISTALINOOE,CAMARAANTERIOROD, ");
                sql.Append("CAMARAANTERIOROE,OBSERVACAOBIOMICROSCOPIA ");
                ...
                sql = sql.Replace("ESCLEROTICAOD", ESCLEROTICAOD).Replace("ESCLEREOTICAOE", ESCLEREOTICAOE).Replace("ESCLEREOTICAOE", ESCLEREOTICAOE).Replace("CORNEAOD", CORNEAOD);
        ...
        public DataTable PesquisarBiomicroscopia(string IDCONSULTA)
        {
            try
            {
                ...
                sql.Append("palpebraOd as \'Pálpebra OD\', palpebraOe as \'Pálpebra OE\',ConjuntivOd as \'Conjuntiva OD\',conjuntivaOe as \'Conjuntiva OE\', escleroticaOd as \'Esclerotica OD, ");

...
namespace AcessoDados
{
    public class RxFinalAcesso
    {
        ...
        public bool CadastrarRxFinal(string IDCONSULTA, string ESFERAVLOD, string ESFERAVLOE, string ESFERAVPOD, string ESFERAVPOE, string CILINDROVLOD, string CILINDROVLOE, 
            ...
            string dnpOd,string dnpOe,string ADICAO,string DP, string TIPOMATERIAL, string COR, string USO, string TIPOLENTE,string OBSERVACAORXFINAL)
        {
            try
            {
                StringBuilder sql = new StringBuilder();
                ...
                sql.Append("eixoVpOd,eixoVpOe,avVlOd,avVlOe,avVpOd,avVpOe,dnpOd,dnpOe,adicao,dp,tipoMaterial,cor,uso,tipoLente,observacaoRxFinal) values ");
                sql.Append("(\'IDCONSULTA\',\'ESFERAVLOD\',\'ESFERAVLOE\',\'ESFERAVPOD\',\'ESFERAVPOE\',\'CILINDROVLOD\',\'CILINDROVLOE\',\'CILINDROVPOD\',\'CILINDROVPOE\', ");
                sql.Append("\'EIXOVLOD\',\'EIXOVLOE\',\'EIXOVPOD\',\'EIXOVPOE\',\'AVVLOD\',\'AVVLOE\',\'AVVPOD\',\'AVVPOE\',\'DNPOD\',\'DNPOE\',\'ADICAO\',\'DP\',\'TIPOMATERIAL\',\'COR\',\'USO\', ");
                ...
                sql = sql.Replace("AVVLOD", AVVLOD).Replace("AVVLOE", AVVLOE).Replace("AVVPOD", AVVPOD).Replace("AVVPOE", AVVPOE).Replace("DNPOD", dnpOd).Replace("DNPOE", dnpOe);
                sql = sql.Replace("ADICAO", ADICAO).Replace("DP", DP).Replace("TIPOMATERIAL", TIPOMATERIAL).Replace("TIPOLENTE", TIPOLENTE).Replace("COR", COR).Replace("USO", USO);
                sql = sql.Replace("OBSERVACAORXFINAL", OBSERVACAORXFINAL);
            ...
            string DP, string TIPOMATERIAL, string COR, string USO, string TIPOLENTE, string OBSERVACAORXFINAL)
        {
            try
            {
                ...
                sql.Append("eixoVlOe= \'VLOEEIXO\',eixoVpOd = \'VPODEIXO\',eixoVpOe= \'VPOEEIXO\',avVlOd= \'AVVLOD\',avVlOe=\'AVVLOE\',avVpOd=\'AVVPOD\',avVpOe=\'AVVPOE\',dnpOd = \'DNPOD\', ");
                sql.Append("dnpOe = \'DNPOE\',adicao=\'ADICAO\',dp= \'DP\',tipoMaterial=\'TIPOMATERIAL\',cor=\'COR\',uso=\'USO\',tipoLente=\'TIPOLENTE\',observacaorxFinal=\'OBSERVACAORXFINAL\' ");
                ...
                sql = sql.Replace("AVVLOE", AVVLOE).Replace("AVVPOD", AVVPOD).Replace("AVVPOE", AVVPOE).Replace("DNPOD",DNPOD).Replace("DNPOE",DNPOE).Replace("ADICAO", ADICAO).Replace("DP", DP);

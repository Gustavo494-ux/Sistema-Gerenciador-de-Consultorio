...
namespace AcessoDados
{
    ...
    {
        public void Atualizar(int codigo, string estado,string cidade,string bairro, string rua,string numero, string cep, string referencia, string observacao)
        {
            ...
            try
            {
                ...
                sql.Append("UPDATE endereco SET estado = @estado,cidade = @cidade,rua = @rua,numero = @numero,cep = @cep,pontoReferencia = @referencia,observacaoEndereco = @observacao");

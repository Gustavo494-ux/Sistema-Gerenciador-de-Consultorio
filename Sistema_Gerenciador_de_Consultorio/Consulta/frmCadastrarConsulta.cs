...
namespace Sistema_Gerenciador_de_Consultorio
{
    public partial class frmCadastrarConsulta : Form
    {
        ...
        //                txtAjudaOpticaPrescrita.Text, dtpUltimaConsulta.Value, txtTranscricaoLentes.Text, txtObservacaoReceita.Text, cbStatusConsulta.Text, txtObservacaoConsulta.Text);
        ...
        //                dtpUltimaConsulta.Text = Convert.ToString(dtgIntermediario.Rows[0].Cells["dataUltimoExame"].Value);
        ...
        //                txtTranscricaoLentes.Text = Convert.ToString(dtgIntermediario.Rows[0].Cells["transcricaoLentes"].Value);
        ...
        private void salvarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (aunteUsuario.NovaConsulta(idNivel) == true)//Verifica se o usuário do sistema tem autorização para realizar consultas.
            {
                ...
                //{
                //    if (txtNomePaciente.TextLength > 0)//ver
                //    {
                //        Cadastrar();
                //    }
                //    else

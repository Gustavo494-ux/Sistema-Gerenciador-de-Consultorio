...
{
    public class EditarAntecedentesOcularesRegra
    {
            ...
            bool alergicos, string alergicosTratamento, bool pterigio, string pterigioTratamento, bool defeitosRefracao, string defeitosRefracaoTratamento, string outro, string outroTratamento)
        {
            try
            {
                if (Validar(idAntecedentesOculares, traumaOcular, traumaOcularTratamento, corpoEstranho, corpoEstranhoTratamento, queimaduras, queimadurasTratamento, cirurgicos, cirurgicosTratamento, inflamacoes,
                ...
                {
                    EditarAntecendentesOcularesAcesso EditarAcesso = new EditarAntecendentesOcularesAcesso();
            ...
            {
                MessageBox.Show("Ocorreu um erro ao atualizar os Antecedentes Oculare(Classe EditarAntecedentesOcularesRegra, Método Editar)", "Erro de atualização/edição",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
            return false;
        }

        public bool Validar(int idAntecedentesOculares, bool traumaOcular, string traumaOcularTratamento, bool corpoEstranho, string corpoEstranhoTratamento, bool queimaduras, string queimadurasTratamento,
            bool cirurgicos, string cirurgicosTratamento, bool inflamacoes, string inflamacoesTratamento, bool catarata, string catarataTratamento, bool glaucoma, string glaucomaTratamento,
            bool cegueira, string cegueiraTratamento, bool descolamentoRetina, string descolamentoRetinaTratamento, bool toxoplasmose, string toxoplasmoseTratamento, bool estrabismo, string estrabismoTratamento,
            bool alergicos, string alergicosTratamento, bool pterigio, string pterigioTratamento, bool defeitosRefracao, string defeitosRefracaoTratamento, string outro, string outroTratamento)
        { 
            ...
            {
                MessageBox.Show("Ocorreu um erro ao validar os Antecedentes Oculares(Classe EditarAntecedentesOcularesRegra, Método Validar)", "Erro de Validação",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
            return false;
        }
    }

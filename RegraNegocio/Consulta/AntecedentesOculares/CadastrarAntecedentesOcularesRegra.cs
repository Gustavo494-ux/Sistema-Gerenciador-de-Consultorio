...
{
    public class CadastrarAntecedentesOcularesRegra
    {
            ...
            bool alergicos, string alergicosTratamento, bool pterigio, string pterigioTratamento, bool defeitosRefracao, string defeitosRefracaoTratamento, string outro, string outroTratamento)
        {
            try
            {
                ...
                {
                    CadastrarAntedecentesOcularesAcesso cadastrarAcesso = new CadastrarAntedecentesOcularesAcesso();
            ...
            {
                MessageBox.Show("Ocorreu um erro ao cadastrar os Antecedentes Oculares(Classe CadastrarAntecedentesOcularesRegra, Método Cadastrar)", "Erro de cadastro",MessageBoxButtons.OK,MessageBoxIcon.Error);
                return false;
            }
            return false;
        }
           ...
           bool alergicos, string alergicosTratamento, bool pterigio, string pterigioTratamento, bool defeitosRefracao, string defeitosRefracaoTratamento, string outro, string outroTratamento)
        {
            ...
            {
                MessageBox.Show("Ocorreu um erro ao validar os Antecedentes Oculares(Classe CadastrarAntecedentesOcularesRegra, Método Validar)", "Erro de validação", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            return false;
        }
